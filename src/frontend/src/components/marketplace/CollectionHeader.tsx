...
export const CollectionHeader: React.FC<CollectionHeaderProps> = ({
  ...
  const [isFollowing, setIsFollowing] = useState(collection.isFollowing || false);
        ...
        <div className="collection-header__info">
          ...
          <div className="collection-header__stats">
            <div className="collection-header__stat">
              <span className="collection-header__stat-value">{collection.stats.items}</span>
              <span className="collection-header__stat-label">{t("items")}</span>
            </div>
            
            <div className="collection-header__stat">
              <span className="collection-header__stat-value">{collection.stats.owners}</span>
              <span className="collection-header__stat-label">{t("owners")}</span>
            </div>
            
            <div className="collection-header__stat">
              <span className="collection-header__stat-value">{collection.stats.floorPrice} ETH</span>
              <span className="collection-header__stat-label">{t("floor_price")}</span>
            </div>
            
            <div className="collection-header__stat">
              <span className="collection-header__stat-value">{collection.stats.volumeTraded} ETH</span>
              <span className="collection-header__stat-label">{t("volume_traded")}</span>
            </div>
          </div>
        </div>
      </div>
