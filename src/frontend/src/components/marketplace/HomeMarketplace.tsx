  ...
  const loadMarketplaceData = async () => {
    try {
      ...
      const featuredNFTData: FeaturedNFTItem = {
        ...
        description:
          "A mesmerizing digital artwork that transports viewers to a dreamlike landscape where reality and imagination intertwine.",
        image:
          "https://images.unsplash.com/photo-1644333192098-75573dacbb0c?q=80&w=1000",
        price: 2.5,
        instantPrice: 10,
        currency: "ETH",
  ...
  return (
    <div className={`home-marketplace ${className}`}>
      <section className="home-marketplace__featured">
        {featuredNFT && (
          <FeaturedNFT nft={featuredNFT} onPlaceBid={handlePlaceBid} />
        )}
      </section>

      <section className="home-marketplace__collections">
        <div className="home-marketplace__section-header">
          <h2 className="home-marketplace__section-title">
            {t("top_collections")}
          </h2>
