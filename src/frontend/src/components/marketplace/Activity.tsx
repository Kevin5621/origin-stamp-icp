      ...
      const mockActivities: ActivityItem[] = [
        {
          ...
          nft: {
            ...
            image:
              "https://images.unsplash.com/photo-1541661538396-53ba2d051eed?q=80&w=100",
          },
          user: {
            id: "user-1",
            name: "ArtistOne",
        ...
        },
        {
          ...
          nft: {
            ...
            image:
              "https://images.unsplash.com/photo-1573221566340-81bdde00e00b?q=80&w=100",
          },
          user: {
            id: "user-2",
            name: "CollectorX",
        ...
        },
        {
          ...
          nft: {
            ...
            image:
              "https://images.unsplash.com/photo-1553356084-58ef4a67b2a7?q=80&w=100",
          },
          user: {
            id: "user-4",
            name: "CryptoWhale",
        ...
        },
        {
          ...
          nft: {
            ...
            image:
              "https://images.unsplash.com/photo-1563089145-599997674d42?q=80&w=100",
          },
          user: {
            id: "user-5",
            name: "ArtFoundation",
            avatar:
              "https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?q=80&w=100",
          },
          fromUser: {
            id: "user-6",
            name: "PrivateCollector",
            avatar:
              "https://images.unsplash.com/photo-1552058544-f2b08422138a?q=80&w=100",
          },
        ...
        },
        {
          ...
          nft: {
            ...
            image:
              "https://images.unsplash.com/photo-1604871000636-074fa5117945?q=80&w=100",
          },
          user: {
            id: "user-7",
            name: "ArtEnthusiast",
        ...
        },
        {
          ...
          nft: {
            ...
            image:
              "https://images.unsplash.com/photo-1547891654-e66ed7ebb968?q=80&w=100",
          },
          user: {
            id: "user-8",
            name: "DigitalCreator",
        ...
        },
        {
          ...
          nft: {
            ...
            image:
              "https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?q=80&w=100",
          },
          user: {
            id: "user-9",
            name: "NFTTrader",
          ...
          fromUser: {
            ...
            name: "ArtistTwo",
            avatar:
              "https://images.unsplash.com/photo-1548142813-c348350df52b?q=80&w=100",
          },
          price: 4.5,
          currency: "ETH",
      ...
      <header className="activity__header">
        <div className="activity__header-content">
          ...
          <p className="activity__subtitle">
            {t(
              "activity_subtitle",
              "Track recent marketplace actions and transactions.",
            )}
          </p>
        </div>
          ...
          <div className="activity__search-container">
            ...
            <input
              ...
              placeholder={t(
                ...
                "Search by NFT, user or transaction ID",
              )}
              value={searchQuery}
