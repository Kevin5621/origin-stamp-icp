...
const ActivityFeed: React.FC<ActivityFeedProps> = ({
  ...
  const formatActivityTitle = (activity: Activity) => {
    switch (activity.type) {
      ...
      case 'collection_created':
        return t('activity_collection_created', { name: activity.collectionName });
      case 'follow_user':
      ...
      <div className="activity-feed__content">
        {activities.length === 0 ? (
          <div className="activity-feed__empty">
            <Clock size={48} />
            <h4 className="activity-feed__empty-title">{t('no_activity_yet')}</h4>
          ...
          <>
            {activities.map((activity) => (
              <div key={activity.id} className="activity-feed__item">
                <div className={`activity-feed__icon ${getActivityColor(activity.type)}`}>
                ...
                <div className="activity-feed__details">
                  <div className="activity-feed__title-row">
                    ...
                    {activity.price && (
                      <span className="activity-feed__price">{activity.price}</span>
                    )}
                  </div>
