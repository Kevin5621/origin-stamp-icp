...
export const generateTopCollections = (
  timeRange: TimeRangeType,
): CollectionStat[] => {
  const baseCollections = [
    {
      ...
      thumbnail:
        "https://images.unsplash.com/photo-1614812513172-567d2fe96a75?q=80&w=100",
    },
    {
      id: "collection-2",
      name: "CryptoPunks",
      thumbnail:
        "https://images.unsplash.com/photo-1607893378714-007fd47c8719?q=80&w=100",
    },
    {
      id: "collection-3",
      name: "Azuki",
      thumbnail:
        "https://images.unsplash.com/photo-1578632767115-351597cf2477?q=80&w=100",
    },
    {
      id: "collection-4",
      name: "Doodles",
      thumbnail:
        "https://images.unsplash.com/photo-1592492152545-9695d3f473f4?q=80&w=100",
    },
    {
      id: "collection-5",
      name: "CloneX",
      thumbnail:
        "https://images.unsplash.com/photo-1557672172-298e090bd0f1?q=80&w=100",
    },
    {
      id: "collection-6",
      name: "Art Blocks",
      thumbnail:
        "https://images.unsplash.com/photo-1597176116047-876a32798fcc?q=80&w=100",
    },
    {
      id: "collection-7",
      name: "Moonbirds",
      thumbnail:
        "https://images.unsplash.com/photo-1617791160536-598cf32026fb?q=80&w=100",
    },
    {
      id: "collection-8",
      name: "Proof Collective",
      thumbnail:
        "https://images.unsplash.com/photo-1622547748225-3fc4abd2cca0?q=80&w=100",
    },
    {
      id: "collection-9",
      name: "World of Women",
      thumbnail:
        "https://images.unsplash.com/photo-1633250587605-92d0cad3e0e6?q=80&w=100",
    },
    {
      id: "collection-10",
      name: "Meebits",
      thumbnail:
        "https://images.unsplash.com/photo-1618005198919-d3d4b5a92ead?q=80&w=100",
    },
  ];
  ...
  if (timeRange !== "all") {
    for (let i = shuffledCollections.length - 1; i > 0; i--) {
      ...
      [shuffledCollections[i], shuffledCollections[j]] = [
        shuffledCollections[j],
  ...
  return shuffledCollections
    .map((collection, index) => {
      ...
      const randomFactor =
        timeRange === "24h" ? 0.1 : timeRange === "7d" ? 0.5 : 1;
