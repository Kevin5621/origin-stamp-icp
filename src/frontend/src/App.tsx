      ...
      <div className="page-container">
        ...
        <main className="main-content">
              ...
              <div className="bento-hero">
                <article className="hero-primary-card">
                  <div className="hero-content">
                    ...
                    >
                      <span className="btn-text">Mulai Verifikasi Karya Saya</span>
                ...
                <aside className="hero-features">
                  <div className="feature-card">
                    ...
                    <p className="feature-description">Proses kreatif direkam secara real-time</p>
                  </div>
                  ...
                  <div className="feature-card">
                    ...
                    <p className="feature-description">Sertifikat permanen di Internet Computer</p>
                  </div>
                  ...
                  <div className="feature-card">
                    ...
                    <p className="feature-description">Bukti keaslian yang dapat diverifikasi</p>
                  </div>
                </aside>
              </div>
            </section>
            ...
            <section className="dashboard-section" aria-labelledby="dashboard-title">
              <div className="bento-dashboard">
                <header className="dashboard-header-card">
                  <h2 id="dashboard-title" className="dashboard-title">Dashboard Kreator</h2>
                  <button
                ...
                <div className="projects-grid">
                  <article className="empty-state-card">
                    ...
                    <p className="empty-state-description">
                      Klik "Proyek Baru" untuk memulai verifikasi karya pertama Anda
                    </p>
            ...
            <section className="session-section" aria-labelledby="session-title">
              <div className="bento-session">
                <header className="session-header-card">
                  <h2 id="session-title" className="session-title">Sesi Perekaman Aktif</h2>
                  <div className="session-status-indicator">
                    <div className="recording-dot" aria-label="Sedang merekam"></div>
                    <span className="status-text">Merekam Proses Kreatif...</span>
                  </div>
                </header>
          ...
          {currentView === "finalization" && (
            <section className="finalization-section" aria-labelledby="finalization-title">
              <div className="bento-finalization">
                <header className="finalization-header">
                  <h2 id="finalization-title" className="finalization-title">Finalisasi Proyek</h2>
            ...
            <section className="verification-section" aria-labelledby="verification-title">
              <div className="bento-verification">
                <header className="verification-header">
                  <h2 id="verification-title" className="verification-title">Sertifikat Keaslian</h2>
                ...
                <article className="certificate-card">
                  <div className="certificate-header">
                    ...
                    <h3 className="certificate-title">Sertifikat Keaslian Diterbitkan</h3>
