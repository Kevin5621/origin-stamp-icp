...
const CreateNFTPage: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.title.trim()) {
      newErrors.title = t(
        "marketplace.create.titleRequired",
        "Title is required",
      );
    }
    ...
    if (!formData.description.trim()) {
      newErrors.description = t(
        "marketplace.create.descriptionRequired",
    ...
    if (!formData.price || parseFloat(formData.price) <= 0) {
      newErrors.price = t(
        "marketplace.create.priceRequired",
    ...
    if (!formData.file) {
      newErrors.file = t(
        "marketplace.create.fileRequired",
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({
        submit: t("marketplace.create.createFailed", "Failed to create NFT"),
      });
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="create-nft-page">
      <div className="create-nft-page__header">
        ...
        <h1>{t("marketplace.create.title", "Create New NFT")}</h1>
      </div>

      <div className="create-nft-page__content">
        <div className="create-nft-page__upload-section">
          <div className="form-section">
            <h2>{t("marketplace.create.uploadFile", "Upload File")}</h2>
              ...
              {!previewUrl ? (
                ...
                >
                  ...
                  <div className="upload-text">
                    {t(
                      "marketplace.create.dragAndDrop",
                      "Drag and drop your file here",
                    )}
                  </div>
                  <div className="upload-subtext">
                    {t(
                      "marketplace.create.orClickToBrowse",
                      "or click to browse",
                    )}
                  </div>
                  <div className="upload-formats">
                    {t(
                      "marketplace.create.supportedFormats",
        ...
        <div className="create-nft-page__form-section">
          <form onSubmit={handleSubmit}>
            <div className="form-section">
              <h2>{t("marketplace.create.nftDetails", "NFT Details")}</h2>

              <div className="form-group">
                <label htmlFor="title">
                  {t("marketplace.create.titleLabel", "Title")}{" "}
                ...
                <input
                  ...
                  placeholder={t(
                    "marketplace.create.titlePlaceholder",
                    "Enter NFT title",
                  )}
                  maxLength={100}
                />
              ...
              <div className="form-group">
                <label htmlFor="description">
                  {t("marketplace.create.description", "Description")}{" "}
                  <span className="required">*</span>
                </label>
                <textarea
                  id="description"
                  ...
                  placeholder={t(
                    "marketplace.create.descriptionPlaceholder",
                    "Describe your NFT",
                  )}
                  rows={4}
                  maxLength={1000}
              ...
              <div className="price-group">
                <div className="form-group">
                  <label htmlFor="price">
                    {t("marketplace.create.price", "Price")}{" "}
                    <span className="required">*</span>
                  </label>
                  <input
                    id="price"
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder={t(
                    "marketplace.create.collectionPlaceholder",
              ...
              <div className="form-group">
                <label>{t("marketplace.create.tags", "Tags")}</label>
            ...
            <div className="form-section">
              <div className="originstamp-section">
                <div className="originstamp-section__header">
                  ...
                  <h3>
                    {t(
                      "marketplace.create.originStamp",
                ...
                <div className="originstamp-section__description">
                  {t(
                    "marketplace.create.originStampDescription",
                    "Your NFT will be automatically verified with OriginStamp, providing proof of creation process and authenticity.",
                  )}
                </div>
                <div className="originstamp-section__benefits">
                  ...
                  <div className="benefit">
                    <CheckCircle className="icon" />
                    {t(
                      "marketplace.create.benefit3",
                      "Enhanced value and trust",
                    )}
                  </div>
                </div>
              </div>
