...
const UserDashboardPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "activity" | "transactions" | "listings" | "settings"
  >("overview");
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      const [dashboardStats, userActivity, userNFTs] = await Promise.all([
      ...
      <div className="user-dashboard__content">
        {activeTab === "overview" && (
          <div className="user-dashboard__overview">
            {/* Stats Component */}
            {stats && <DashboardStats stats={stats} loading={false} />}
            ...
            {transactions.length === 0 ? (
              ...
              <div className="user-dashboard__transactions-list">
                {transactions.map((transaction) => (
                  <div
                    key={transaction.id}
                    className="user-dashboard__transaction"
                  >
