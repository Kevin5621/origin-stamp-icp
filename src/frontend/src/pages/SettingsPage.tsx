    ...
    <div className="settings-page">
      <div className="settings-container">
        ...
        <div className="settings-section">
          <h2 className="settings-section-title">{t("account_information")}</h2>
        ...
        {user?.loginMethod === "username" && (
          <div className="settings-section">
            <h2 className="settings-section-title">{t("security_settings")}</h2>
          ...
          <div className="settings-card">
            ...
            <div className="notification-option">
              <div className="notification-info">
                ...
                <div>
                  <h4 className="notification-title">{t("project_updates")}</h4>
                  <p className="notification-description">
            ...
            <div className="notification-option">
              <div className="notification-info">
                ...
                <div>
                  <h4 className="notification-title">{t("security_alerts")}</h4>
                  <p className="notification-description">
        ...
        {/* Appearance Settings */}
        <div className="settings-section">
          <h2 className="settings-section-title">{t("appearance_settings")}</h2>
        ...
        {/* Danger Zone */}
        <div className="settings-section">
          <h2 className="settings-section-title">{t("danger_zone")}</h2>
