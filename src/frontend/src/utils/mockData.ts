...
export const mockNFTs: NFT[] = [
  {
    ...
    description: 'A mesmerizing digital artwork exploring the concept of dreams in the digital age. Created using advanced AI tools and traditional artistic techniques.',
  ...
  },
  {
    ...
    description: 'A vibrant cyberpunk cityscape with neon lights and futuristic architecture. Each building tells a story of urban evolution.',
  ...
  },
  {
    ...
    description: 'An abstract composition exploring color theory and geometric patterns. Created through a unique process combining digital and traditional techniques.',
    imageUrl: 'https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=400&h=400&fit=crop',
    creator: mockUsers[0],
    price: {
      amount: '3.2',
  ...
  },
  {
    id: 'nft_004',
    title: 'Digital Flora',
    description: 'A series of digital flowers that bloom and change with time. Each flower is unique and responds to environmental data.',
  ...
  },
  {
    ...
    description: 'A journey through the cosmos, exploring the vastness of space and the beauty of celestial bodies.',
  ...
  },
  {
    ...
    description: 'Minimalist approach to urban photography, capturing the essence of city life through simple geometric forms.',
    imageUrl: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=400&h=400&fit=crop',
    creator: mockUsers[1],
    price: {
      amount: '0.8',
...
export const mockCollections: Collection[] = [
  {
    id: 'collection_001',
    name: 'Digital Dreams',
    description: 'A collection exploring the intersection of dreams and digital reality. Each piece is created through a unique process combining AI and human creativity.',
  ...
  },
  {
    id: 'collection_002',
    name: 'Urban Futures',
    description: 'Exploring the future of urban landscapes through digital art. From cyberpunk cities to minimalist architecture.',
    coverImage: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=600&h=300&fit=crop',
    creator: mockUsers[1],
  ...
  },
  {
    id: 'collection_003',
    name: 'Digital Nature',
    description: 'A series of digital flora and fauna that respond to environmental data and change over time.',
    coverImage: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=600&h=300&fit=crop',
    creator: mockUsers[1],
    nfts: [mockNFTs[3]],
    stats: {
      totalItems: 5,
