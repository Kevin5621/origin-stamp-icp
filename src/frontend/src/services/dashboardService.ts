    ...
    return [
      {
        ...
        description:
          '"Digital Waves #3" has been successfully verified with 127 process entries',
      ...
      },
      {
        ...
        description:
          'Authenticity certificate for "Abstract Storm" minted on Internet Computer',
      ...
      },
      {
        ...
        description:
          "New recording session for physical sculpture documentation",
