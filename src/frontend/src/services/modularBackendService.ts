/**
 * New Modular Backend Service
 * Combines all modular services into a single service interface
 * Maintains backward compatibility with existing backendService usage
 */
...
import { getBackendActor, isBackendAvailable, getBackendCanisterId } from "./core";

/**
 * Modular Backend Service
 * Provides all backend functionality through organized modules
 * Backward compatible with the original backendService
 */
export const modularBackendService = {
  ...
  getUserSubscriptionLimits: subscriptionManagementService.getUserSubscriptionLimits,
  ...
  initializeUserSubscription: subscriptionManagementService.initializeUserSubscription,
 ...
 * Can be used as a drop-in replacement for the original backendService
 */
export const backendServiceModular = modularBackendService;
